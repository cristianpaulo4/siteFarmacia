        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Escolha o Estado:</h6>
             ...
             <form action="pagcliente.php" method="POST">
                <input type="hidden" name="estado" value="Bahia">
                <input type="hidden" name="cidade" value="Formosa">
                <input type="hidden" name="bairro" value="Centro">
                <a class="collapse-item" href="pagcliente.php" >Bahia</a>
             </form>
